---
title: "nirmitin_FinalHomeworkCode_05"
author: "Nirmiti Naik"
date: "11/10/2021"
output: 
  html_document:
...
Next, I will run a linear regression on log(HomeRange_km2) and log(Body_mass_female_mean). This informs us of our β coeffiecients: β1 = 1.036 and β0 = -9.441. I added the na.omit() function but it doesn't seem to have made a difference to my coefficient values - not too sure why? 
```{r linear regression}
...
# **Extra Credit - not completed, tried to defined some elements to better understand it**
Arguments:
+ d = data frame
+ m = linear model
...
*will need to use the boot function (or a loop) somewhere in your function!*